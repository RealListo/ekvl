...
NEconomy = {
	...
	TRADEZONE_VALUE_MULT = 0.3,						-- Multiple on trade zone value in tradezone bonus to trade posts and cities
	...
	TRADE_CONNECTED_TO_CAPITAL_BONUS = 0.2,			-- Bonus to trade post income when connected to capital
	TRADE_POST_COST_INC_DIST = 0.002,				-- The % increase in cost due to distance to closest connected province
	TRADE_POST_OPINION_EFFECT = 0.4,				-- The bonus or penalty depending on topliege opinion
	MAX_TRADE_POSTS_BASE = 2,
...
NMilitary = {
	...
	COMMAND_MODIFIER_MARTIAL_MULTIPLIER = 0.025,	  -- How much positive command modifiers are increased, and negative modifiers decreased (capped to 100% for negative), per point of martial
